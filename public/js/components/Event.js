        ...
        <div className="container">
          <div className="d-flex flex-column">
            {/* <div className="d-flex flex-row event_header">
              <div className="p-2 flex-fill"><h4 className='text-muted'>{event.destination_name} >> {event.name}</h4></div>

            </div> */}
            <div className="d-flex flex-row flex-wrap">
              <div className="flex-column flex-fill flex-shrink-1">
                <div className="p-2">
                  <h4 className='text-muted'>{event.destination_name} >> {event.name}</h4>
                ...
                <div className="p-2 text-muted"><span className="details_label">PRICE PER PERSON</span> ${event.price_per_person}</div>
